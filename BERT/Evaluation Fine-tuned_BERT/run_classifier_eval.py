...
class DataProcessor(object):
  ...
  def _read_tsv(cls, input_file, quotechar=None):
    df = pd.read_csv(input_file, sep='\t', index_col=0, engine='python', encoding='utf8')
...
class MyDataProcessor(DataProcessor):
    ...
    def get_test_examples(self, data_dir):
        return self._create_examples(self._read_txt(os.path.join(data_dir, "jokes.txt")), "test")
